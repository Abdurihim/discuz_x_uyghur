...
function insertAttach(id) {
	...
	if(extensions != '' && (re.exec(extensions) == null || ext == '')) {
		alert('كەچۈرۈڭ، كېڭەيتىلگەن نامى بۇنىڭدەك رەسىمنى يوللىغىلى بولمايدۇ');
		return;
	}
	...
	if(typeof no_insert=='undefined') {
		localfile += '&nbsp;<a href="javascript:;" class="xi2" title="بۇ يەرنى چېكىپ مەزمۇن كىرگۈزۈڭ" onclick="insertAttachimgTag(' + id + ');return false;">[قىستۇرۇش]</a>';
	}
	inhtml += '<td><strong>' + localfile +'</strong>';
	inhtml += '</td><td class="d">رەسىم چۈشەندۈرۈلۈشى<br/><textarea name="pic_title" cols="40" rows="2" class="pt"></textarea>';
	inhtml += '</td><td class="o"><span id="showmsg' + id + '"><a href="javascript:;" onclick="delAttach(' + id + ');return false;" class="xi2">[ئۆچۈرۈش]</a></span>';
	inhtml += '</td></tr></table>';
...
function upload() {
	...
	if(nowUid>0) {
		...
		if(uploadStat==1) {
			...
			upobj.innerHTML = 'يوللاش مەغلۇب بولدى '+uploadStat;
		}
	}

	if($('showmsg'+nid) != null) {
		$('showmsg'+nid).innerHTML = 'يوللىنىۋاتىدۇ، سەل ساقلاڭ(<a href="javascript:;" onclick="forms[nowUid].submit();">قايتا سىناش</a>)';
