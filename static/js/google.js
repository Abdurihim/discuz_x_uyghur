...
document.writeln('<option value="0"' + google_default_0 + '>توردىن ئىزدەش</option>');
document.writeln('<option value="1"' + google_default_1 + '>بېكەتتىن ئىزدەش</option>');
document.writeln('</select>');
document.writeln('&nbsp;<button type="submit" name="sa" value="true">ئىزدەش</button>');
