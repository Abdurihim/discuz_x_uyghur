...
drag.extend({
	...
	init : function (sampleMode) {
		this.initCommon();
		$('samplepanel').innerHTML = 'قېلىپنىڭ سانلىق مەلۇماتلىرىنى بىۋاستە ئۆزگەرتكىلى بولىدۇ [<a href="javascript:;" onclick="spaceDiy.cancel();return false;" class="xi2">چىكىنىش</a>]';
