		...
		<head>
			...
			<style type="text/css">
				@font-face {
					...
					src: url('/uwf.eot');
					src: local('☺'), local("Alpida Unicode System"),
					url('/uwf.eot?') format('eot'), url('/uwf.woff') format('woff'), url('/uwf.ttf') format('truetype');
					font-weight: normal;
					font-style: normal;
				}
			</style>
...
<script src="{STATICURL}js/ug_vk.min.js?{VERHASH}" charset="{CHARSET}"></script>
			<script type="text/javascript" src="static/js/NUIedit.js"></script>
...
body, td, input, button, select, textarea {font: 15px/1.5em Alpida Unicode System, UKIJ Tuz Tom, Microsoft Uighur, DejaVu Sans, Helvetica Neue, Segoe UI, Helvetica, Tahoma, Arial, sans-serif;}
textarea { resize: none; font-size: 15px; line-height: 1.8em; }
				...
				*:lang(zh) a.cs{height:12px}
				.cs .cb{font-size:0;display:block;width:10px;height:8px;position:absolute;right:4px;top:3px;cursor:hand!important;cursor:pointer}
				.cs span{position:absolute;right:19px;top:0px;cursor:hand!important;cursor:pointer;color:#333}
				...
				.mf_link{font-size:13px;color:#000000;text-decoration:none}
				.mf_link:hover{font-size:13px;color:#000000;text-decoration:underline}
				...
				.toobar, .toobarmini{position:relative;height:29px;overflow:hidden}
				...
				*:lang(zh) .tble{top:2px}
				.tbri{width:90px;position:absolute;right:3px;top:2px;background-position:0 -33px}
				...
				*:lang(zh) .icons a{margin-right:1px}
				...
				a.icoFullTxt{ float: right; width: 60px; height: 20px; line-height: 20px; border: 1px solid #C2D5E3; background: url(static/image/common/card_btn.png) repeat-x 0 100%; text-align: center; color: #333; text-decoration: none; }
	...
	<?php } ?>
							...
							<div id="fontface" class="eMenu" style="z-index:99;display:none;top:35px;left:2px;width:110px;height:265px">
								<a href="javascript:;" onClick="fontname(this);return false;" class="n" style="font:normal 13px '<?php echo lang('home/editor', 'editor_font_song'); ?>';"><?php echo lang('home/editor', 'editor_font_song'); ?></a>
								<a href="javascript:;" onClick="fontname(this);return false;" class="n" style="font:normal 13px '<?php echo lang('home/editor', 'editor_font_hei'); ?>';"><?php echo lang('home/editor', 'editor_font_hei'); ?></a>
								<a href="javascript:;" onClick="fontname(this);return false;" class="n" style="font:normal 13px '<?php echo lang('home/editor', 'editor_font_kai'); ?>';"><?php echo lang('home/editor', 'editor_font_kai'); ?></a>
								<a href="javascript:;" onClick="fontname(this);return false;" class="n" style="font:normal 13px '<?php echo lang('home/editor', 'editor_font_li'); ?>';"><?php echo lang('home/editor', 'editor_font_li'); ?></a>
								<a href="javascript:;" onClick="fontname(this);return false;" class="n" style="font:normal 13px '<?php echo lang('home/editor', 'editor_font_you'); ?>';"><?php echo lang('home/editor', 'editor_font_you'); ?></a>
								<a href="javascript:;" onClick="fontname(this);return false;" class="n" style="font:normal 13px Arial;">Arial</a>
								<a href="javascript:;" onClick="fontname(this);return false;" class="n" style="font:normal 13px 'Arial Narrow';">Arial Narrow</a>
								<a href="javascript:;" onClick="fontname(this);return false;" class="n" style="font:normal 13px 'Arial Black';">Arial Black</a>
								<a href="javascript:;" onClick="fontname(this);return false;" class="n" style="font:normal 13px 'Comic Sans MS';">Comic Sans MS</a>
								<a href="javascript:;" onClick="fontname(this);return false;" class="n" style="font:normal 13px Courier;">Courier</a>
								<a href="javascript:;" onClick="fontname(this);return false;" class="n" style="font:normal 13px System;">System</a>
								<a href="javascript:;" onClick="fontname(this);return false;" class="n" style="font:normal 13px 'Times New Roman';">Times New Roman</a>
								<a href="javascript:;" onClick="fontname(this);return false;" class="n" style="font:normal 13px Verdana;">Verdana</a>
							</div>
							...
							<div id="divList" class="eMenu" style="display:none;top:35px;left:26px;width:94px;height:40px;"><a href="javascript:;" onClick="format('Insertorderedlist');fHide(this.parentNode);return false;" class="n"><?php echo lang('home/editor', 'editor_list_order'); ?></a><a href="javascript:;" onClick="format('Insertunorderedlist');fHide(this.parentNode);return false;" class="n"><?php echo lang('home/editor', 'editor_list_unorder'); ?></a></div>
							<div id="divInOut" class="eMenu" style="display:none;top:35px;left:26px;width:104px;height:40px;"><a href="javascript:;" onClick="format('Indent');fHide(this.parentNode);return false;" class="n"><?php echo lang('home/editor', 'editor_indent_inc'); ?></a><a href="javascript:;" onClick="format('Outdent');fHide(this.parentNode);return false;" class="n"><?php echo lang('home/editor', 'editor_indent_dec'); ?></a></div>
	...
	<?php echo lang('home/editor', 'editor_prompt_imagelink'); ?>:<br/>
							...
							<div id="createSwf" class="eMenu" style="display:none;top:35px;left:26px;width:400px;font-size:13px">
	<?php echo lang('home/editor', 'editor_prompt_videolink'); ?>:<br/>
							...
							<div id="createPage" class="eMenu" style="display:none;top:35px;left:26px;width:300px;font-size:13px">
							...
							<div id="dvhtml" style="height:100%;width:100%;overflow:hidden">
								<SCRIPT LANGUAGE="JavaScript">
									function blank_load() {
										...
										nuiKeyFunc('HtmlEditor',null);/* Nurqut NUIedit for iframe by FinalDream 20121007*/
									}
...
body { direction:rtl; margin: 0; padding: 5px; word-wrap: break-word; font-size:15px; line-height:1.8em; font-family: Alpida Unicode System, UKIJ Tuz Tom, Microsoft Uighur, DejaVu Sans, Helvetica Neue, Segoe UI, Helvetica, Tahoma, Arial, sans-serif; }
			</style>
